...
<section id="projects" class="py-24 bg-white">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4 h-auto md:h-[600px] reveal delay-200">
            ...
            <a href="{{ route('user.detail-project') }}" class="md:col-span-2 md:row-span-2 rounded-[2rem] overflow-hidden group relative cursor-pointer block">
            ...
            <a href="{{ route('user.detail-project') }}" class="md:col-span-2 md:row-span-1 rounded-[2rem] overflow-hidden group relative cursor-pointer block">
            ...
            <a href="{{ route('user.detail-project') }}" class="md:col-span-1 md:row-span-1 rounded-[2rem] overflow-hidden group relative cursor-pointer block">
