...
<head>
    ...
    <title>Verifikasi Email Reset - Jayra Construction</title>
    ...
    <div class="w-full max-w-[950px] px-5 z-10 flex flex-col items-center">
        ...
        <div class="bg-[#F6C624] w-full rounded-[1.2rem] shadow-card py-16 px-6 sm:px-12 flex flex-col items-center relative overflow-hidden animate-fade-up delay-200 group">
            ...
            <form action="#" method="POST" class="w-full flex flex-col items-center z-10">
                ...
                <!-- Verify Button -->
                <a href="{{ route('verification-password-success') }}" class="w-full max-w-[280px] inline-block text-center py-[14.5px] bg-navy text-white rounded-[12px] font-[700] text-[15.5px] btn-hover-effect mb-8 animate-fade-up" style="animation-delay: 800ms; opacity: 0;">
                    Verify Now
                </a>
