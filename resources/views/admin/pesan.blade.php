...
<div class="container-fluid p-4 p-lg-5">
    ...
    }" class="messages-container shadow-sm border rounded bg-body"> <!-- Ganti ke bg-body -->
        <div class="messages-layout d-flex" style="height: 70vh;">
            
            <!-- Sidebar Pesan (Kiri) -->
            <!-- Ubah bg-white ke bg-body -->
            <div class="messages-sidebar border-end" style="width: 350px; flex-shrink: 0;">
                <!-- Ubah bg-light ke bg-body-tertiary -->
                ...
                <div class="conversations-list overflow-auto" style="height: calc(100% - 60px);">
                    <template x-for="inquiry in inquiries" :key="inquiry.id">
                        <div @click="selectedId = inquiry.id" 
                            ...
                            :class="selectedId === inquiry.id ? 'bg-primary-subtle border-start border-primary border-4' : 'bg-body'" 
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    <div class="d-flex justify-content-between">
                                        <h6 class="mb-0 text-truncate text-body" :class="inquiry.status === 'unread' ? 'fw-bold' : ''" x-text="inquiry.name"></h6>
            ...
            <!-- Ubah bg-light ke bg-body-tertiary -->
            <div class="chat-area bg-body-tertiary flex-grow-1 d-flex flex-column">
                <template x-if="selectedInquiry">
                    <div class="h-100 d-flex flex-column">
                        <!-- Header Info User (bg-body) -->
                        <div class="p-3 bg-body border-bottom d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <h6 class="mb-0 text-body" x-text="selectedInquiry.name"></h6>
                        ...
                        <div class="p-4 flex-grow-1 overflow-auto">
                            <!-- Ganti bg-white ke bg-body, hapus text-dark -->
                            <div class="bg-body p-3 shadow-sm rounded-3 mb-3 border-start border-success border-4" style="max-width: 85%;">
                                <p class="mb-2 text-body" x-text="selectedInquiry.message"></p>
                                <small class="text-muted d-block text-end" x-text="selectedInquiry.date"></small>
                            </div>
                        </div>

                        <!-- Tombol Balas WhatsApp (bg-body) -->
                        <div class="p-4 bg-body border-top text-center">
